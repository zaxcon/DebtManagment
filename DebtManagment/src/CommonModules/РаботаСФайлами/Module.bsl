...
Функция ДобавитьФайл(ПараметрыФайла,
	...
	КонецЕсли;
	ТипЗагруженногоДокумента =Неопределено; 
	ВидЗагруженногоДокумента = Неопределено;
	...
	Если ПараметрыФайла.Свойство("ТипЗагруженногоДокумента",ТипЗагруженногоДокумента) тогда 
	ПрисоединенныйФайл.ТипЗагруженногоДокумента = ТипЗагруженногоДокумента;	
	КонецЕсли;	
   	Если ПараметрыФайла.Свойство("ВидЗагруженногоДокумента",ВидЗагруженногоДокумента) тогда 
	ПрисоединенныйФайл.ВидЗагруженногоДокумента = ВидЗагруженногоДокумента;	
	КонецЕсли;	
